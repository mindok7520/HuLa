...
const defaultNaiveLocalePack = naiveLocaleMap['ko-KR']
...
// 라우트 훅 함수 및 요청 함수 내에서 호출할 수 있도록 naive 컴포넌트 메서드를 window에 마운트
