<template>
  ...
  <n-flex vertical :size="20" data-tauri-drag-region>
    ...
    <!--      <n-flex vertical>-->
    <!--        <span>비밀번호 지우기</span>-->
    <!--        <span class="text-12px text-#909090">지운 후에는 다음에 QR 코드 또는 계정 비밀번호로 로그인해야 합니다</span>-->
    <!--      </n-flex>-->
    <!--      <n-button secondary type="primary" @click="clearInfo"> 비밀번호 지우기 </n-button>-->
    <!--    </n-flex>-->
  </n-flex>
</template>
