<template>
  <!-- 테마 전환이 필요 없는 인터페이스를 감싸기 위해 n-config-provider를 단독으로 사용 -->
  <n-config-provider
    :theme="naiveTheme"
...
/**
 * 입력란 상태 변경 처리
 * @param type 입력란 타입: nickName-닉네임 / email-이메일 / password-비밀번호 / confirmPassword-비밀번호 확인
 * @param event 이벤트 객체
 */
