...
const startDrag = (e: MouseEvent) => {
  ...
  // addEventListener의 세 번째 매개변수 { passive: true }를 사용하여 성능 최적화
...
const checkScrollbar = () => {
  ...
  imgContainer.value.style.height = 'auto' // 올바른 계산을 위해 먼저 auto로 초기화
  // 스크롤바가 있는지 확인
...
onMounted(async () => {
  ...
  if (imageViewerStore.isSingleMode) {
    // 단일 이미지 모드에서는 imageList 및 currentIndex를 설정할 필요가 없음
