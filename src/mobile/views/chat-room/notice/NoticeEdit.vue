        ...
        <div class="flex flex-col flex-1 gap-20px py-15px px-20px">
          ...
          <div class="bg-white rounded-15px p-15px shadow">
            <n-form label-placement="top" size="medium">
              ...
              <n-form-item label="이미지 업로드 (현재 지원되지 않음)">
                <div class="upload-image-container">
                  <n-upload
                    ...
                    <div class="upload-trigger">
                      ...
                      <span class="text-12px text-#999 mt-5px">업로드하려면 클릭</span>
                    </div>
                  </n-upload>
                </div>
              </n-form-item>
            ...
            <div class="flex flex-col w-full">
              <div class="flex justify-between py-15px px-15px items-center border-b border-gray-200">
                <div class="flex flex-col">
                  ...
                  <div class="text-12px text-gray-500 mt-5px">공지가 그룹 공지 목록 상단에 표시됩니다</div>
                </div>
